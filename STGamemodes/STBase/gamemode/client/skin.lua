...
derma.DefineSkin( "SassilizationSkin", "Nothing special.", SKIN )


PANEL = {} --Borrowed from garry and modified for sassilization.
...
function PANEL:Paint()
	derma.SkinHook( "Paint", "Connect", self )
	
	derma.SkinHook( "PaintOver", "Connect", self )

	return false
end

function PANEL:ApplySchemeSettings()
	derma.SkinHook( "Scheme", "Connect", self )
...
derma.DefineControl( "ServerConnect", "Backwards Compatibility", PANEL, "DLabel" )
...
function PANEL:Paint()
	...
	derma.SkinHook( "Paint", "TextEntry", self, self:GetWide(), self:GetTall() )
	return false
...
function PANEL:PerformLayout()
	...
	derma.SkinHook( "Layout", "TextEntry", self, self:GetWide(), self:GetTall() )
...
derma.DefineControl( "SassTextEntry", "A simple TextEntry control", PANEL, "DTextEntry" )
