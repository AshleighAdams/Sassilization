...
SKIN.PrintName 		= "SassStore"
SKIN.Author 		= "xAaron113x"
SKIN.DermaVersion	= 1
SKIN.GwenTexture	= Material( "sassilization/skins/sassstore.png" )
...
derma.DefineSkin( "SassSkin", "Made to look like regular VGUI", SKIN )